// MOCK 0xBitcoin Token Testnet- M0xBTC Token - Token Contract
//
...
//
//
// Distrubtion of MOCK 0xBitcoin Token - M0xBTC Token is as follows:
// 
// 100% of 0xBitcoin accepted for BWORK Tokens and R0xBTC Tokens.
//
// (1 R0xBTC + 1 BWORK) <-> 1 Mock_0xBitcoin Token
//
// Symbol: M0xBTC
// Decimals: 8
//
// Total supply: 10,835,900.00000000
//   =
// 10,835,900 0xBitcoin Tokens are able to be transfered for BWORK tokens.
//
...
/////
//IMPORT Includes below, then main RightsTo0xBitcoin Mainnet Ethereum contract
/////
...
// No dev cut, or advantage taken at launch. Convert anytime no deadline.
     ...
     // DELETE OR COMMENT OUT FOR MAINNET // DELETE OR COMMENT OUT FOR MAINNET // DELETE OR COMMENT OUT FOR MAINNET
 // DELETE OR COMMENT OUT FOR MAINNET BELOW BELOW BELOW
//TEST APPROVAL FEATURE WORKS
//REMOVE FOR MAINNET LAUNCH
...
interface ApproveAndCallFallBack {
    function receiveApproval(
     ...
     // DELETE OR COMMENT OUT FOR MAINNET // DELETE OR COMMENT OUT FOR MAINNET // DELETE OR COMMENT OUT FOR MAINNET
 // DELETE OR COMMENT OUT FOR MAINNET BELOW BELOW BELOW
contract a0xBitcoin_mock is ERC20Permit {
